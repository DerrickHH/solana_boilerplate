import { MINIMAL_MARKET_STATE_LAYOUT_V3, MinimalMarketLayoutV3, getMinimalMarketV3, logger } from '../helpers';
...
export class MarketCache {
    ...
    async init(config: { quoteToken: Token }) {
        ...
        // TODO: DEVNET 是有 PROGRAM_ID 的，目前不知道哪个是 TESTNET 的 PROGRAM_ID 变量
