...
class Config:
    ...
    def load_config(self):
        if not os.path.exists(self.path):
            log_general.error("Soltrade was unable to detect the JSON file. Are you sure config.json has not been renamed or removed?")
            exit(1)
        ...
        with open(self.path, 'r') as file:
            try:
                ...
                self.compute_unit_price_micro_lamports = int(config_data.get("compute_unit_price_micro_lamports", 20 * 14000))
